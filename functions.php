<?php
/**
 * Mammut Construction functions and definitions
 *
...
if ( ! function_exists( 'starter_theme_setup' ) ) :
	...
	function starter_theme_setup() {
		 ...
		 * If you're building a theme based on Mammut Construction, use a find and replace
		...
		register_nav_menus(
			array(
				'menu-header' => esc_html__( 'Primary', 'starter-theme' ),
			)
		);
